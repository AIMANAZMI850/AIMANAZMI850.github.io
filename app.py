...
def index():
    ...
    heatmap_path = 'static/image/heatmap.html'  # Path to save the heatmap HTML file
    fig.write_html(heatmap_path, auto_open=False)  # Save the interactive heatmap as HTML
...
def compare():
    ...
    # Convert the scatter plot to an interactive HTML representation
    import mpld3
    html_fig = mpld3.fig_to_html(fig)

    # Render the compare.html template and pass the HTML representation
    return render_template('compare.html', html_fig=html_fig)
